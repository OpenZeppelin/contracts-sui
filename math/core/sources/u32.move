...
#[error(code = 0)]
const EPow10ExponentTooLarge: vector<u8> = b"Power of 10 exponent is too large to fit in u32";

/// The bit width of the `u32` type (32 bits).
const BIT_WIDTH: u8 = 32;

/// Maximum exponent for `pow_10` that fits in `u32`.
///
/// Determined by the constraint: 10^MAX_POW_10_EXPONENT <= u32::MAX < 10^(MAX_POW_10_EXPONENT+1)
/// 10^9 = 1000000000 ✓, 10^10 = 10000000000 > `std::u32::max_value!()` ✗
const MAX_POW_10_EXPONENT: u8 = 9;
