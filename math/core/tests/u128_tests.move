...
fun log2_rounds_down() {
    ...
    assert_eq!(u128::log2(3, down), 1); // log2(3) ≈ 1.58 → 1
    assert_eq!(u128::log2(5, down), 2); // log2(5) ≈ 2.32 → 2
    assert_eq!(u128::log2(7, down), 2); // log2(7) ≈ 2.81 → 2
    assert_eq!(u128::log2(15, down), 3); // log2(15) ≈ 3.91 → 3
    assert_eq!(u128::log2(255, down), 7); // log2(255) ≈ 7.99 → 7
}
...
fun log2_rounds_up() {
    ...
    let up = rounding::up();
    assert_eq!(u128::log2(3, up), 2); // log2(3) ≈ 1.58 → 2
    assert_eq!(u128::log2(5, up), 3); // log2(5) ≈ 2.32 → 3
    assert_eq!(u128::log2(7, up), 3); // log2(7) ≈ 2.81 → 3
    assert_eq!(u128::log2(15, up), 4); // log2(15) ≈ 3.91 → 4
    assert_eq!(u128::log2(255, up), 8); // log2(255) ≈ 7.99 → 8
}
...
fun log2_rounds_to_nearest() {
    ...
    assert_eq!(u128::log2(3, nearest), 2); // log2(3) ≈ 1.58 → 2
    assert_eq!(u128::log2(5, nearest), 2); // log2(5) ≈ 2.32 → 2
    assert_eq!(u128::log2(7, nearest), 3); // log2(7) ≈ 2.81 → 3
    assert_eq!(u128::log2(15, nearest), 4); // log2(15) ≈ 3.91 → 4
    assert_eq!(u128::log2(255, nearest), 8); // log2(255) ≈ 7.99 → 8
}
