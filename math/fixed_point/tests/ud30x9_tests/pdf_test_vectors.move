...
fun pdf_vectors_match_oracle() {
    let cases = vector[
        ...
        TestCase { z_raw: 426_800_000, expected: 364_212_550 },
        TestCase { z_raw: 500_000_000, expected: 352_065_327 },
        TestCase { z_raw: 853_700_000, expected: 277_110_100 },
        TestCase { z_raw: 1_000_000_000, expected: 241_970_725 },
        TestCase { z_raw: 1_280_500_000, expected: 175_734_902 },
        TestCase { z_raw: 1_707_400_000, expected: 92_870_808 },
        TestCase { z_raw: 1_960_000_000, expected: 58_440_944 },
        TestCase { z_raw: 2_000_000_000, expected: 53_990_967 },
        TestCase { z_raw: 2_134_200_000, expected: 40_911_530 },
        TestCase { z_raw: 2_561_100_000, expected: 15_017_259 },
        TestCase { z_raw: 2_987_900_000, expected: 4_595_344 },
        TestCase { z_raw: 3_000_000_000, expected: 4_431_848 },
        TestCase { z_raw: 3_414_800_000, expected: 1_171_620 },
        TestCase { z_raw: 3_841_600_000, expected: 249_043 },
        TestCase { z_raw: 4_000_000_000, expected: 133_830 },
        TestCase { z_raw: 4_268_500_000, expected: 44_103 },
        TestCase { z_raw: 4_695_300_000, expected: 6_512 },
        TestCase { z_raw: 5_000_000_000, expected: 1_487 },
        TestCase { z_raw: 5_122_200_000, expected: 801 },
        TestCase { z_raw: 5_549_000_000, expected: 82 },
        TestCase { z_raw: 5_975_900_000, expected: 7 },
        TestCase { z_raw: 6_000_000_000, expected: 6 },
        TestCase { z_raw: 6_402_700_000, expected: 1 },
        TestCase { z_raw: 6_402_729_806, expected: 0 },
        TestCase { z_raw: 6_410_000_000, expected: 0 },
