...
public use fun openzeppelin_fp_math::ud30x9_base::div_away as UD30x9.div_away;
public use fun openzeppelin_fp_math::ud30x9_base::div_trunc as UD30x9.div_trunc;
public use fun openzeppelin_fp_math::ud30x9_base::floor as UD30x9.floor;
public use fun openzeppelin_fp_math::ud30x9_base::ln as UD30x9.ln;
public use fun openzeppelin_fp_math::ud30x9_base::log10 as UD30x9.log10;
public use fun openzeppelin_fp_math::ud30x9_base::log2 as UD30x9.log2;
