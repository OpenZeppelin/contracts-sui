...
/// at - the common DeFi shorthand for an 18-decimal fixed-point number. Running
/// finer than the user-facing `10^9` scale keeps intermediate rounding well
/// below the final result's precision.
