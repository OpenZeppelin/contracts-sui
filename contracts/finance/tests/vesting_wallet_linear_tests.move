...
fun new_stepped(
    ...
    let (wallet, cap) = vesting_wallet_linear::new<USDC>(
        BENEFICIARY,
        start,
        cliff,
        period,
...
fun new_continuous(
    ...
    let (wallet, cap) = vesting_wallet_linear::new_continuous<USDC>(
        BENEFICIARY,
        start,
        cliff,
        duration,
...
fun destroy_after_end_on_empty_wallet() {
    ...
    let (mut wallet, cap) = vesting_wallet_linear::new<USDC>(
        BENEFICIARY,
        0,
        0,
        1000,
