...
/// map, so the abort surfaces at `openzeppelin_sorted_set::sorted_set` - a consumer's
...
/// as-is.
module openzeppelin_sorted_set::unlock_queue;
...
/// at `location = openzeppelin_sorted_set::sorted_set`) if the queue is empty - guard with
