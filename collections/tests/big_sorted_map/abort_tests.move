...
module openzeppelin_collections::big_sorted_map_abort_tests;
...
#[
    expected_failure(
        abort_code = openzeppelin_collections::big_sorted_map::EMapNotEmpty,
...
#[
    expected_failure(
        abort_code = openzeppelin_collections::big_sorted_map::EKeyNotFound,
        location = openzeppelin_collections::big_sorted_map,
    ),
]
...
#[
    expected_failure(
        abort_code = openzeppelin_collections::big_sorted_map::EEmpty,
        location = openzeppelin_collections::big_sorted_map,
    ),
]
...
#[
    expected_failure(
        abort_code = openzeppelin_collections::big_sorted_map::EWouldExceedTier1EntryHeuristic,
        location = openzeppelin_collections::big_sorted_map,
    ),
]
...
#[
    expected_failure(
        abort_code = openzeppelin_collections::big_sorted_map::ESourceNotSortedUnderComparator,
        location = openzeppelin_collections::big_sorted_map,
    ),
]
...
#[
    expected_failure(
        abort_code = openzeppelin_collections::big_sorted_map::EWrongNodeKind,
        location = openzeppelin_collections::big_sorted_map,
    ),
]
